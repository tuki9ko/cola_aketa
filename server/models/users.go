...
type User struct {
	...
	UserIcon       string `boil:"user_icon" json:"user_icon" toml:"user_icon" yaml:"user_icon"`
...
var UserWhere = struct {
	...
	Biography:      whereHelperstring{field: "\"users\".\"biography\""},
	UserIcon:       whereHelperstring{field: "\"users\".\"user_icon\""},
}
...
var UserRels = struct {
	...
	Role:        "Role",
	ColaResults: "ColaResults",
}

// userR is where relationships are stored.
type userR struct {
	Role        *UserRole       `boil:"Role" json:"Role" toml:"Role" yaml:"Role"`
	ColaResults ColaResultSlice `boil:"ColaResults" json:"ColaResults" toml:"ColaResults" yaml:"ColaResults"`
}
...
func (r *userR) GetColaResults() ColaResultSlice {
	if r == nil {
		return nil
	}
	return r.ColaResults
}
...
var (
	userAllColumns            = []string{"id", "name", "email", "hashed_password", "role_id", "biography", "user_icon"}
	userColumnsWithoutDefault = []string{"name", "email", "hashed_password", "role_id", "biography", "user_icon"}
...
func (o *User) Role(mods ...qm.QueryMod) userRoleQuery {
...
// ColaResults retrieves all the cola_result's ColaResults with an executor.
func (o *User) ColaResults(mods ...qm.QueryMod) colaResultQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"cola_results\".\"user_id\"=?", o.ID),
	)
...
// LoadColaResults allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadColaResults(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		...
		qm.WhereIn(`cola_results.user_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if singular {
		object.R.ColaResults = resultSlice
		for _, foreign := range resultSlice {
			if foreign.R == nil {
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.ID == foreign.UserID {
				local.R.ColaResults = append(local.R.ColaResults, foreign)
				if foreign.R == nil {
					foreign.R = &colaResultR{}
				}
...
func (o *User) SetRole(ctx context.Context, exec boil.ContextExecutor, insert bool, related *UserRole) error {
	var err error
	if insert {
...
// AddColaResults adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.ColaResults.
// Sets related.R.User appropriately.
func (o *User) AddColaResults(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*ColaResult) error {
	var err error
	...
	if o.R == nil {
		...
		o.R.ColaResults = append(o.R.ColaResults, related...)
	}
